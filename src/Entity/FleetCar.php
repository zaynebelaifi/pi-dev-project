...
class FleetCar
{
    ...
    // ── Aliases for fleet status ──────────────────────────────────────────

    /** Alias for $status — used by FleetService. */
    public function getCarStatus(): string { return $this->getStatus(); }
    public function setCarStatus(string $s): self { return $this->setStatus($s); }

    /** Alias for $fuel_level — used by FleetService. */
    public function getFuelLevelPercent(): ?int { return $this->fuel_level; }
