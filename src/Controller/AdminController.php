...
final class AdminController extends AbstractController
{
    ...
    public function dashboard(Request $request, DeliveryRepository $deliveryRepository, DeliveryManRepository $deliveryManRepository, FleetCarRepository $fleetCarRepository): Response
    {
